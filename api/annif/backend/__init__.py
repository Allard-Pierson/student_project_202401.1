...
def _decision_tree() -> Type[AnnifBackend]:
    from . import decision_tree

    return decision_tree.DecisionTreeBackend
...
def _xtransformer() -> Type[AnnifBackend]:
    try:
        ...
        raise ValueError("XTransformer not available, cannot use XTransformer backend")
